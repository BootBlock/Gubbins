...
The same protection holds when the change comes from somewhere the bridge doesn't control — the
app's own [[folder sync|Cloud-Sync]] saving to the shared file, or a separate
