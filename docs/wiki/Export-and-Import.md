...
| --- | --- | --- |
| [[Activity\|Activity-Log]] | Activity → Items | Every change, with the item, what happened, any quantity or value movement, and who made it |
| [[Location activity\|Activity-Log]] | Activity → Locations | Every change to a location — when, which place, what happened, the detail and who made it |
