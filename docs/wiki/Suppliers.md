...
| **Default currency** | Picked from the same currency list as your Settings base currency. Used when a part or order under this supplier doesn't state a currency of its own; leave it on **Use base currency** to fall back to your [[base currency|Language-and-Region]]. |
