...
> limitation it left is filed as [#693](https://github.com/BootBlock/Gubbins/issues/693). `N7`
> shipped 2026-07-31 — see §11.6. `N3` is **resolved without building it** — see §11.4. `N4` and
