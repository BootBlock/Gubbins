      ...
      <div className="flex flex-col gap-6">
        ...
        {mayDowngrade ? (
          ...
          >
             ...
             * the sync artefact has never been — `SyncSnapshot` carries no image bytes at all. A
             * backup .zip is the only thing that holds a full-resolution photo, so that is what
             * the user is pointed at, before the confirm rather than after it.
             */}
            <Banner
              tone="warning"
