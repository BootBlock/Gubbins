...
export const CATEGORY_PRESETS: readonly CategoryPreset[] = [
    ...
    seed: {
      ...
      fields: ordered([
        { name: 'Cover art', fieldType: 'IMAGE' },
        {
          name: 'Format',
          fieldType: 'SELECT',
          options: ['DVD', 'Blu-ray', '4K UHD Blu-ray', '3D Blu-ray', 'Digital', 'VHS', 'LaserDisc'],
        },
        { name: 'Director', fieldType: 'TEXT' },
        { name: 'Cast', fieldType: 'LONG_TEXT' },
        { name: 'Genre', fieldType: 'TEXT' },
        { name: 'Release year', fieldType: 'NUMBER' },
        { name: 'Runtime (min)', fieldType: 'NUMBER' },
        { name: 'Studio', fieldType: 'TEXT' },
        {
          name: 'Region',
          fieldType: 'SELECT',
          options: ['Region-free', 'A', 'B', 'C', 'Region 1', 'Region 2', 'Region 3', 'Region 4'],
        },
        {
          name: 'Edition',
          fieldType: 'SELECT',
        ...
        { name: 'Certification', fieldType: 'TEXT' },
        { name: 'Barcode (UPC/EAN)', fieldType: 'TEXT' },
        { name: 'Reference (IMDb/TMDB)', fieldType: 'URL' },
        { name: 'Media file', fieldType: 'FILE' },
        { name: 'Rating', fieldType: 'RATING' },
        { name: 'Watched', fieldType: 'ON_OFF' },
      ]),
    },
  },
  {
  ...
  },
  {
    ...
    name: 'Tool bag',
    description: 'Bags, rolls and cases that hold a kit — type, material and what lives inside.',
    seed: {
      category: { name: 'Tool bag', glyph: '🧰' },
      fields: ordered([
        {
          name: 'Type',
          fieldType: 'SELECT',
          options: ['Tool bag', 'Tool roll', 'Tool box', 'Hard case', 'Backpack', 'Pouch', 'Tote'],
        },
        { name: 'Brand', fieldType: 'TEXT' },
        {
          name: 'Material',
          fieldType: 'SELECT',
          options: ['Canvas', 'Polyester', 'Nylon', 'Leather', 'Plastic', 'Metal'],
        },
        { name: 'Number of pockets', fieldType: 'NUMBER' },
        { name: 'Contents', fieldType: 'LONG_TEXT' },
      ]),
    },
  },
  {
    ...
    sectionId: 'containers',
    name: 'First aid kit',
    description: 'Medical kits and bags — setting, standard, expiry and whether it needs a restock.',
    seed: {
      category: { name: 'First aid kit', glyph: '⛑️' },
      fields: ordered([
        {
          name: 'Setting',
          fieldType: 'SELECT',
          options: ['Home', 'Vehicle', 'Workplace', 'Travel', 'Outdoor', 'Sports'],
        },
        { name: 'Compliance standard', fieldType: 'TEXT' },
        { name: 'People covered', fieldType: 'NUMBER' },
        { name: 'Contents last checked', fieldType: 'DATE' },
        { name: 'Earliest expiry', fieldType: 'DATE' },
        { name: 'Needs restocking', fieldType: 'ON_OFF' },
      ]),
    },
  },
  {
    ...
    sectionId: 'containers',
    name: 'Storage tote',
    description: 'Boxes, totes and crates — material, capacity and whether it stacks and seals.',
    seed: {
      category: { name: 'Storage tote', glyph: '📦' },
      fields: ordered([
        {
          name: 'Type',
          fieldType: 'SELECT',
          options: ['Plastic tote', 'Cardboard box', 'Crate', 'Basket', 'Drawer unit', 'Vacuum bag'],
        },
        {
          name: 'Material',
          fieldType: 'SELECT',
          options: ['Plastic', 'Cardboard', 'Fabric', 'Metal', 'Wood'],
        },
        { name: 'Capacity (L)', fieldType: 'NUMBER' },
        { name: 'Colour', fieldType: 'TEXT' },
        { name: 'Lidded', fieldType: 'ON_OFF' },
        { name: 'Stackable', fieldType: 'ON_OFF' },
        { name: 'Contents', fieldType: 'LONG_TEXT' },
      ]),
    },
  },
  {
    ...
    sectionId: 'containers',
    name: 'Gridfinity bin',
    description: 'Modular 3D-printed bins — footprint in 42mm grid units, height in 7mm units.',
    seed: {
      category: { name: 'Gridfinity bin', glyph: '🗄️' },
      fields: ordered([
        {
          name: 'Type',
          fieldType: 'SELECT',
          options: ['Bin', 'Lite bin', 'Baseplate', 'Divider bin', 'Custom'],
        },
        { name: 'Width (42mm units)', fieldType: 'NUMBER' },
        { name: 'Depth (42mm units)', fieldType: 'NUMBER' },
        { name: 'Height (7mm units)', fieldType: 'NUMBER' },
        { name: 'Compartments', fieldType: 'NUMBER' },
        { name: 'Filament / colour', fieldType: 'TEXT' },
        { name: 'Magnetic base', fieldType: 'ON_OFF' },
        { name: 'Contents', fieldType: 'LONG_TEXT' },
      ]),
    },
  },
