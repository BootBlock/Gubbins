  ...
  switch (fieldType) {
    ...
    case 'LONG_TEXT':
      return (
        ...
        // is that resizing one settles the height for all of them — and, as everywhere else,
        // a height the user chose outranks auto-grow, so they stop fitting their content.
        <Textarea
